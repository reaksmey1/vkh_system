  ...
  //window.alert("clicked internal btn!");
		...
		$('#spare_part_detail tr').each(function() {
		    ...
		    if (i > 1) {
		      ...
		      sell_data.push({code: code, name: name, amount: amount, unit_price: unit_price, total_price: total_price, sub_total: sub_total, recieved: recieved, return_money: return_money})
		    }
		 });
	  $.ajax({
	      type: "POST",
